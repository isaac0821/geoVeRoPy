...
# Polygon Touring Problem
def solvePTP(startPt: pt, endPt: pt, polys: polys, algo: str = 'SOCP', **kwargs):
    ...
    **kwargs: optional
    ...
    def _solvePTPAdaptIter(startPt: pt, endPt: pt, polys: polys, adaptErr):
    ...
    def _solvePTPSOCP(startPt: pt, endPt: pt, polys: polys, outputFlag = False, gapTol = None, timeLimit = None):
        segs = []
    ...
    def _solveSegTPSOCP(startPt: pt, endPt: pt, segs: list[line], outputFlag = False, gapTol = None, timeLimit = None):
    ...
    if (algo == 'AdaptIter'):
        ...
        res = _solvePTPAdaptIter(startPt, endPt, polys, adaptErr)
    elif (algo == 'SOCP'):
        outputFlag = False
...
# Circle Touring Problem
def solveCTP(startPt: pt, endPt: pt, circles: list[dict], algo: str = 'SOCP', **kwargs):
    ...
    **kwargs: optional
    ...
    def _solveCTPAdaptIter(startPt: pt, endPt: pt, circles: list[dict], adaptErr, initLod: int = 4):
    ...
    def _solveCTPSOCP(startPt: pt, endPt: pt, circles: list[dict], outputFlag: bool = False):
    ...
    if (algo == 'AdaptIter'):
        ...
        res = _solveCTPAdaptIter(startPt, endPt, circles, adaptErr, initLod)
    elif (algo == 'SOCP'):
        outputFlag = False
        if ('outputFlag' in kwargs):
            outputFlag = kwargs['outputFlag']
        # print(circles)
        res = _solveCTPSOCP(startPt, endPt, circles, outputFlag)
    else:
        raise UnsupportedInputError("ERROR: Not support by vrpSolver for now.")
